...
| 0x40 |        | EOR iX |        |        |        | EOR zp |        |        |
| 0x48 |        | EOR #  |        |        | JMP ab | EOR ab |        |        |
| 0x50 | BVC r  | EOR iY |        |        |        | EOR zX |        |        |
| 0x58 | CLI    | EOR aY |        |        |        | EOR aX |        |        |
| 0x60 |        | ADC iX |        |        |        | ADC zp |        |        |
| 0x68 |        | ADC #  |        |        | JMP id | ADC ab |        |        |
...
| 0x98 | TYA    |        | TXS    |        |        |        |        |        |
| 0xA0 |        | LDA iX |        |        |        | LDA zp |        |        |
| 0xA8 | TAY    | LDA #  | TAX    |        |        | LDA ab |        |        |
| 0xB0 | BCS r  | LDA iY |        |        |        | LDA zX |        |        |
| 0xB8 | CLV    | LDA aY | TSX    |        |        | LDA aX |        |        |
...
| 0x98 | TYA |     | TXS |     |     |     |     |     |
| 0xA0 |     | LDA |     |     |     | LDA |     |     |
| 0xA8 | TAY | LDA | TAX |     |     | LDA |     |     |
| 0xB0 | BCS | LDA |     |     |     | LDA |     |     |
| 0xB8 | CLV | LDA | TSX |     |     | LDA |     |     |
